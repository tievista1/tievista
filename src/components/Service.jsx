...
const SERVICES = [
    ...
    },
    {
        ...
        icon: Network,
        label: '',
        heading: 'Wealth Coordination & Consolidated ',
        accent: 'Reporting',
        body: 'Acting as a central coordination point for your financial ecosystem through structured engagement alongside your chartered accountants, legal teams, bankers, trustees and other professionals, facilitating consolidated reporting across holdings and disclosed assets with clear, intuitive views designed to improve transparency, monitoring and informed decision making through tech enabled dashboards.',
        bullets: [
            'Central coordination and holistic oversight across your entire financial ecosystem',
            'Structured engagement and alignment with CAs, legal, banking teams, trustees and other professionals',
        ...
        img: 'https://res.cloudinary.com/dck5jgfix/image/upload/v1777031379/wealthCordination_Reporting_ht2cfc.png',
        reverse: true,
    },
    {
        id: 'entre',
    ...
    },
    {
        ...
        img: 'https://res.cloudinary.com/dck5jgfix/image/upload/v1774352776/Family_Alignment_Continuity_ueffd4.png',
        reverse: true,
    },
    {
        id: 'relation',
...
function ServiceSection({ svc, index }) {
    ...
    return (
        <section id={id} className={`w-full py-14 border-b border-gray-100 ${bg}`}>
