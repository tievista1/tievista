...
const narratives = [
  {
    ...
    img: 'https://res.cloudinary.com/dck5jgfix/image/upload/v1774346036/A_Structured_Approach_pphvux.png',
    reverse: false,
  },
  {
    icon: Target,
        ...
        <div className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-16 md:gap-20`}>
          ...
          <div className="w-full md:w-1/2">
            <motion.div {...fadeUp(0.2)}>
              ...
              >
                {heading}{' '}
                <span className="text-black" >{accent}</span> {/*style={{ color: GOLD }} */}
              </h2>
